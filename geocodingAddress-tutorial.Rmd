...
#### Input/Output {#GA-i-o}
Our inputs will be a **CSV** file that include addresses of our resources ("chicago_methadone.csv"). To access the test dataset for this tutorial, please download [here]().
