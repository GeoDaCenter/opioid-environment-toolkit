...
Alternatively, if you have not saved the dataset from [get-ACS-Data tutorial](link), you can download it using the code below or from the box folder [here](https://uchicago.app.box.com/folder/123662619823).
