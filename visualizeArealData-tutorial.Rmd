...
``` {r}
chicagoZips <- st_read("data/chizips_ACS.shp")
head(chicagoZips)
```
...
tm_shape(chicagoZips) + tm_fill('prCptIn', title = 'Per Capita Income - Pretty') + 
tm_borders() + 
...
p1 <- tm_shape(chicagoZips) + tm_fill('prCptIn', title = 'Per Capita Income - Quantile', 
...
p2 <- tm_shape(chicagoZips) + tm_fill('prCptIn', title = 'Per Capita Income - Jenks', 
...
p3 <- tm_shape(chicagoZips) + tm_fill('prCptIn', title = 'Per Capita Income - Stdev', 
                                style = 'sd') + tm_borders() + 
      tm_layout(frame = FALSE, legend.outside = TRUE, 
                legend.outside.position = 'right', legend.title.size =0.9,
                main.title = 'Per Capita Income, by Zipcode, Chicago 2018', 
...
tm_shape(chicagoZips) + tm_fill('prCptIn', title = 'Per Capita Income - Jenks', 
...
tm_shape(chicagoZips) + tm_fill('prCptIn', title = 'Per Capita Income - Stdev', 
